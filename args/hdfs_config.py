...
def get_args():
    ...
    parser.add_argument('--max_lens', default=512, type=int, help='Max length of sequence (default: 256)')
    ...
    parser.add_argument('--init_num_epochs', default=10, type=int, help='Initial number of epochs (default: 100)')
    ...
    parser.add_argument('--tqdm', default=True, type=bool, help='Tqdm (default: False)')
